...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(p0, file, 35, 6, 794);
    			add_location(p1, file, 36, 6, 836);
    			attr_dev(div0, "class", "card-text");
    			add_location(div0, file, 34, 5, 763);
    			attr_dev(div1, "class", "card");
    			add_location(div1, file, 33, 4, 738);
    			attr_dev(div2, "class", "col");
    			add_location(div2, file, 32, 4, 715);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(32:4) {#each feedList as item}",
    		ctx
    	});
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(29:15)       loading     {:then data}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 25, 1, 594);
    			add_location(main, file, 24, 0, 585);
    			attr_dev(a, "href", "https://dhiranegi.com");
    			add_location(a, file, 51, 10, 1038);
    			add_location(p, file, 51, 1, 1029);
    			add_location(br, file, 52, 1, 1105);
    			add_location(title, file, 53, 87, 1198);
    			...
    			add_location(path0, file, 53, 119, 1230);
    			...
    			add_location(path1, file, 53, 1763, 2874);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	async function fetchFeed() {
    		...
    		console.log("%c with love from dhira ", "font-weight: bold; font-size: 15px;color: #fc4a1a;  border:1px dotted #f7b733");
    	}
